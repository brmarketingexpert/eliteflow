        ...
        <div class="row q-gutter-md justify-center">
          <div class="col-xs-12 col-sm-shrink">
            <q-card
              ...
              style="min-width: 200px; background-color: #f44336; color: white"
            >
          ...
          <div class="col-xs-12 col-sm-shrink">
            <q-card
              ...
              bordered
              class="my-card full-height"
              style="min-width: 200px; background-color: #4caf50; color: white"
            >
              <q-card-section class="text-center">
                <div class="row items-center">
                  <div class="col">
          ...
          <div class="col-xs-12 col-sm-shrink">
            <q-card
              ...
              bordered
              class="my-card full-height"
              style="min-width: 200px; background-color: #5c67f2; color: white"
            >
              <q-card-section class="text-center">
                <div class="row items-center">
                  <div class="col">
          ...
          <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
            <q-card flat bordered class="my-card full-height" style="background-color: #f44336; color: white">
              <q-card-section class="text-center">
          ...
          <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
            <q-card flat bordered class="my-card full-height" style="background-color: #5c67f2; color: white">
              <q-card-section class="text-center">
                <p class="text-h5 text-bold text-center">
