...
import { ListarTenantPorId, AlterarTenantShowChatbot, AlterarTenantTentativas, AlterarTenantFixarConexoes, AlterarTenantForcarAdmin } from 'src/service/tenants'
